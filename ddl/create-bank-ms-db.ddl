...
create table TRANSACTION (TRANSACTION_ID int4 not null, AMOUNT float8 not null, STATUS varchar(255) not null, WALLET_TRANSACTION_ID varchar(255) not null, ACCOUNT_ID int4 not null, primary key (TRANSACTION_ID));
